...
<form action="regiAf.jsp" method="post"> <!-- 회원가입 버튼이 누르고 정상적으로 회원가입이 성공하면 POST 방식을 사용하여 regiAf.jsp로 이동 -->
...
$(document).ready(function() {
	...
	$("#btn").click(function () {
		...
		$.ajax({
			url:"getId.jsp", // getId.jsp로 데이터를 전송하고 다시 데이터를 받아옴.
			type:"post",
			...
			//	alert(resp.trim());
				...
				if(resp.trim() == "YES"){ // 받아온 데이터값(공백을 제거한) resp가 "YES"라면 사용한 아이디라고 출력 
