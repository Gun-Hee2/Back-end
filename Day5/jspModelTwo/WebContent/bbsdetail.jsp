...
function answerbbs(seq) {
	location.href = "bbsanswer.jsp?seq=" + seq; // 답글 버튼을 눌렀을 때 실행되는 함수, bbsanswer.jsp로 seq값을 가지고 이동
}
function updatebbs(seq) {
	location.href = "bbsupdate.jsp?seq=" + seq; // 수정 버튼을 눌렀을 때 실행되는 함수, bbsupdate.jsp로 seq값을 가지고 이동
}
function deletebbs(seq) {
	location.href = "bbsdelete.jsp?seq=" + seq; // 삭제 버튼을 눌렀을 때 실행되는 함수, bbsdelete.jsp로 seq값을 가지고 이동
}
